        ...
        <div class="wrapper">
            ...
            <form class="p-3 mt-3" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-field d-flex align-items-center">
                    <span class="fs-3 bi bi-person"></span>
                    <input type="text" name="identifier" id="identifier" placeholder="xxxxxxxxxxx">
                </div>
                <label for="password">Password</label>
                <div class="form-field d-flex align-items-center">
                    <span class="fs-3 bi bi-key"></span>
                    <input type="password" name="password" id="password" placeholder="xxxxxxxxxxx">
                </div>
