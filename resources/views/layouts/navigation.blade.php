        ...
        <ul class="nav navbar-nav flex-column ms-1 mt-1">
            ...
            {{-- <li class="nav-item">
                    <a href="{{ route('admin.routeperformance') }}" class="nav-link">
                        ...
                        <span class="ms-2 ms-md-4 nav-name">Route Performance</span>
                    </a>
                </li>
                <li class="nav-item mt-1">
                    <a href="{{ route('admin.stationperformance') }}" class="nav-link">
                        ...
                        <span class="ms-2 ms-md-4 nav-name">Station Performance</span>
                    </a>
                </li>
                ...
                <li class="nav-item mt-1">
                    <a href="" class="nav-link">
                        ...
                        <span class="ms-2 ms-md-4 nav-name">Activity Logs</span>
                    </a>
                </li> --}}
        </ul>
    </div>
